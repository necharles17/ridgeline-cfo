...
- `Website/audit.html`: financial diagnostic hub page (/audit)
- `Website/audit.js`: full quiz app logic (state, scoring, Formspree POST)
...
## Copy & Writing Rules
- **Never use em dashes (—) anywhere on the site or in any copy.** Use commas, colons, or rewrite the sentence instead.
